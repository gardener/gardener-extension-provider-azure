...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*RegionIDMapping)(nil), (*azure.RegionIDMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_RegionIDMapping_To_azure_RegionIDMapping(a.(*RegionIDMapping), b.(*azure.RegionIDMapping), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*azure.RegionIDMapping)(nil), (*RegionIDMapping)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_azure_RegionIDMapping_To_v1alpha1_RegionIDMapping(a.(*azure.RegionIDMapping), b.(*RegionIDMapping), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_MachineImageVersion_To_azure_MachineImageVersion(in *MachineImageVersion, out *azure.MachineImageVersion, s conversion.Scope) error {
	out.Version = in.Version
	out.URN = (*string)(unsafe.Pointer(in.URN))
	out.Regions = *(*[]azure.RegionIDMapping)(unsafe.Pointer(&in.Regions))
	return nil
}
...
func autoConvert_v1alpha1_RegionIDMapping_To_azure_RegionIDMapping(in *RegionIDMapping, out *azure.RegionIDMapping, s conversion.Scope) error {
	out.Name = in.Name
	out.ID = in.ID
	return nil
}

// Convert_v1alpha1_RegionIDMapping_To_azure_RegionIDMapping is an autogenerated conversion function.
func Convert_v1alpha1_RegionIDMapping_To_azure_RegionIDMapping(in *RegionIDMapping, out *azure.RegionIDMapping, s conversion.Scope) error {
	return autoConvert_v1alpha1_RegionIDMapping_To_azure_RegionIDMapping(in, out, s)
}

func autoConvert_azure_RegionIDMapping_To_v1alpha1_RegionIDMapping(in *azure.RegionIDMapping, out *RegionIDMapping, s conversion.Scope) error {
	out.Name = in.Name
	out.ID = in.ID
	return nil
}

// Convert_azure_RegionIDMapping_To_v1alpha1_RegionIDMapping is an autogenerated conversion function.
func Convert_azure_RegionIDMapping_To_v1alpha1_RegionIDMapping(in *azure.RegionIDMapping, out *RegionIDMapping, s conversion.Scope) error {
	return autoConvert_azure_RegionIDMapping_To_v1alpha1_RegionIDMapping(in, out, s)
}

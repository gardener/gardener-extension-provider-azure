...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*RootDisk)(nil), (*azure.RootDisk)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_RootDisk_To_azure_RootDisk(a.(*RootDisk), b.(*azure.RootDisk), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*azure.RootDisk)(nil), (*RootDisk)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_azure_RootDisk_To_v1alpha1_RootDisk(a.(*azure.RootDisk), b.(*RootDisk), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_RootDisk_To_azure_RootDisk(in *RootDisk, out *azure.RootDisk, s conversion.Scope) error {
	out.Caching = (*string)(unsafe.Pointer(in.Caching))
	return nil
}

// Convert_v1alpha1_RootDisk_To_azure_RootDisk is an autogenerated conversion function.
func Convert_v1alpha1_RootDisk_To_azure_RootDisk(in *RootDisk, out *azure.RootDisk, s conversion.Scope) error {
	return autoConvert_v1alpha1_RootDisk_To_azure_RootDisk(in, out, s)
}

func autoConvert_azure_RootDisk_To_v1alpha1_RootDisk(in *azure.RootDisk, out *RootDisk, s conversion.Scope) error {
	out.Caching = (*string)(unsafe.Pointer(in.Caching))
	return nil
}

// Convert_azure_RootDisk_To_v1alpha1_RootDisk is an autogenerated conversion function.
func Convert_azure_RootDisk_To_v1alpha1_RootDisk(in *azure.RootDisk, out *RootDisk, s conversion.Scope) error {
	return autoConvert_azure_RootDisk_To_v1alpha1_RootDisk(in, out, s)
}
...
func autoConvert_v1alpha1_WorkerConfig_To_azure_WorkerConfig(in *WorkerConfig, out *azure.WorkerConfig, s conversion.Scope) error {
	...
	out.RootDisk = (*azure.RootDisk)(unsafe.Pointer(in.RootDisk))
...
func autoConvert_azure_WorkerConfig_To_v1alpha1_WorkerConfig(in *azure.WorkerConfig, out *WorkerConfig, s conversion.Scope) error {
	...
	out.RootDisk = (*RootDisk)(unsafe.Pointer(in.RootDisk))

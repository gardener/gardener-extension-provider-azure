...
var _ = Describe("Helper", func() {
	...
	DescribeTable("#FindMachineImage",
		...
		Entry("entry not found (no name)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}, Architecture: ptr.To("foo")}}, "foo", "1.2.3", ptr.To("foo"), nil, true),
		Entry("entry not found (no version)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}, Architecture: ptr.To("foo")}}, "bar", "1.2.4", ptr.To("foo"), nil, true),
		Entry("entry not found (no architecture)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}, Architecture: ptr.To("bar")}}, "bar", "1.2.3", ptr.To("foo"), nil, true),
		Entry("entry exists(urn)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}, Architecture: ptr.To("foo")}}, "bar", "1.2.3", ptr.To("foo"), &api.MachineImage{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}, Architecture: ptr.To("foo")}, false),
		Entry("entry exists(urn) if architecture is nil", []api.MachineImage{{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}}}, "bar", "1.2.3", ptr.To("amd64"), &api.MachineImage{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}, Architecture: ptr.To("amd64")}, false),
		Entry("entry exists(id)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ImageRef: api.Image{ID: &imageID}, Architecture: ptr.To("foo")}}, "bar", "1.2.3", ptr.To("foo"), &api.MachineImage{Name: "bar", Version: "1.2.3", ImageRef: api.Image{ID: &imageID}, Architecture: ptr.To("foo")}, false),
		Entry("entry exists(communityGalleryImageID)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ImageRef: api.Image{CommunityGalleryImageID: &communityImageId}, Architecture: ptr.To("foo")}}, "bar", "1.2.3", ptr.To("foo"), &api.MachineImage{Name: "bar", Version: "1.2.3", ImageRef: api.Image{CommunityGalleryImageID: &communityImageId}, Architecture: ptr.To("foo")}, false),
		Entry("entry exists(sharedGalleryImageID)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ImageRef: api.Image{SharedGalleryImageID: &sharedImageId}, Architecture: ptr.To("foo")}}, "bar", "1.2.3", ptr.To("foo"), &api.MachineImage{Name: "bar", Version: "1.2.3", ImageRef: api.Image{SharedGalleryImageID: &sharedImageId}, Architecture: ptr.To("foo")}, false),
		Entry("entry exists(accelerated networking active)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}, AcceleratedNetworking: &boolTrue, Architecture: ptr.To("foo")}}, "bar", "1.2.3", ptr.To("foo"), &api.MachineImage{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}, AcceleratedNetworking: &boolTrue, Architecture: ptr.To("foo")}, false),
		Entry("entry exists(accelerated networking inactive)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}, AcceleratedNetworking: &boolFalse, Architecture: ptr.To("foo")}}, "bar", "1.2.3", ptr.To("foo"), &api.MachineImage{Name: "bar", Version: "1.2.3", ImageRef: api.Image{URN: &urn}, AcceleratedNetworking: &boolFalse, Architecture: ptr.To("foo")}, false),
	)
	...
	DescribeTable("#FindImage",
		...
		Entry("profile entry(urn)", makeProfileMachineImages("ubuntu", "1", "3", "5", "6", ptr.To("foo")), "ubuntu", "1", ptr.To("foo"), &api.MachineImage{Name: "ubuntu", Version: "1", ImageRef: api.Image{URN: &profileURN}, Architecture: ptr.To("foo")}),
		Entry("profile entry(id)", makeProfileMachineImages("ubuntu", "1", "3", "5", "6", ptr.To("foo")), "ubuntu", "3", ptr.To("foo"), &api.MachineImage{Name: "ubuntu", Version: "3", ImageRef: api.Image{ID: &profileID}, Architecture: ptr.To("foo")}),
		Entry("profile entry(communiyGalleryId)", makeProfileMachineImages("ubuntu", "1", "3", "5", "6", ptr.To("foo")), "ubuntu", "5", ptr.To("foo"), &api.MachineImage{Name: "ubuntu", Version: "5", ImageRef: api.Image{CommunityGalleryImageID: &profileCommunityImageId}, Architecture: ptr.To("foo")}),
		Entry("profile entry(sharedGalleryId)", makeProfileMachineImages("ubuntu", "1", "3", "5", "6", ptr.To("foo")), "ubuntu", "6", ptr.To("foo"), &api.MachineImage{Name: "ubuntu", Version: "6", ImageRef: api.Image{SharedGalleryImageID: &profileSharedImageId}, Architecture: ptr.To("foo")}),
		...
		Entry("valid image reference, only urn", makeProfileMachineImageWithURNandIDandCommunityGalleryIDandSharedGalleryImageID("ubuntu", "1", &profileURN, nil, nil, nil, ptr.To("foo")),
			"ubuntu", "1", ptr.To("foo"), &api.MachineImage{Name: "ubuntu", Version: "1", ImageRef: api.Image{URN: &profileURN}, Architecture: ptr.To("foo")}),
		Entry("valid image reference, only id", makeProfileMachineImageWithURNandIDandCommunityGalleryIDandSharedGalleryImageID("ubuntu", "1", nil, &profileID, nil, nil, ptr.To("foo")),
			"ubuntu", "1", ptr.To("foo"), &api.MachineImage{Name: "ubuntu", Version: "1", ImageRef: api.Image{ID: &profileID}, Architecture: ptr.To("foo")}),
		Entry("valid image reference, only communityGalleryImageID", makeProfileMachineImageWithURNandIDandCommunityGalleryIDandSharedGalleryImageID("ubuntu", "1", nil, nil, &profileCommunityImageId, nil, ptr.To("foo")),
			"ubuntu", "1", ptr.To("foo"), &api.MachineImage{Name: "ubuntu", Version: "1", ImageRef: api.Image{CommunityGalleryImageID: &profileCommunityImageId}, Architecture: ptr.To("foo")}),
		Entry("valid image reference, only sharedGalleryImageID", makeProfileMachineImageWithURNandIDandCommunityGalleryIDandSharedGalleryImageID("ubuntu", "1", nil, nil, nil, &profileSharedImageId, ptr.To("foo")),
			"ubuntu", "1", ptr.To("foo"), &api.MachineImage{Name: "ubuntu", Version: "1", ImageRef: api.Image{SharedGalleryImageID: &profileSharedImageId}, Architecture: ptr.To("foo")}),
	)

...
func AddToManagerWithOptions(ctx context.Context, mgr manager.Manager, opts AddOptions) error {
	...
	return controlplane.Add(ctx, mgr, controlplane.AddArgs{
		Actuator: NewActuator(mgr, genericactuator.NewActuator(mgr, azure.Name,
			...
			imagevector.ImageVector(), "", nil, opts.WebhookServerNamespace, mgr.GetWebhookServer().Port, gardenerClientset), GracefulDeletionTimeout, GracefulDeletionWaitInterval),

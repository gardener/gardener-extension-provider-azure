...
// Source: github.com/gardener/gardener-extension-provider-azure/pkg/azure/client (interfaces: DNSZone,DNSRecordSet,Subnet,Factory,ResourceGroup,Vnet,RouteTables,NatGateway,PublicIP,AvailabilitySet,NetworkSecurityGroup)
...
func (m *MockResourceGroup) DeleteIfExits(arg0 context.Context, arg1 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockResourceGroupMockRecorder) DeleteIfExits(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteIfExits", reflect.TypeOf((*MockResourceGroup)(nil).DeleteIfExits), arg0, arg1)
}

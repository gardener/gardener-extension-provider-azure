...
bash "${CODE_GEN_DIR}/generate-internal-groups.sh" \
  ...
  github.com/gardener/gardener-extension-provider-azure/pkg/apis \
  "config:v1alpha1" \
  --extra-peer-dirs=github.com/gardener/gardener-extension-provider-azure/pkg/apis/config,github.com/gardener/gardener-extension-provider-azure/pkg/apis/config/v1alpha1,k8s.io/apimachinery/pkg/apis/meta/v1,k8s.io/apimachinery/pkg/conversion,k8s.io/apimachinery/pkg/runtime,github.com/gardener/gardener/extensions/pkg/apis/config/v1alpha1 \
  --go-header-file "${GARDENER_HACK_DIR}/LICENSE_BOILERPLATE.txt"

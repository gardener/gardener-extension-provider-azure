...
networks:
  vnet: # specify either 'name' and 'resourceGroup' or 'cidr'. If none of them is set, networks.workers is re-used cidr
    # name: my-vnet
...
In case none of them is set, the `networks.workers` CIDR will be used to create a new VNet.

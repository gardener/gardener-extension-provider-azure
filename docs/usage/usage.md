...
The rollout is controlled by the worker's MCM settings, but it is suggested that you speed this process so that traffic to your cluster is restored as possible.